...
또한, 현재 많은 프로젝트와 서비스들이 기존의 Java 프로그램을 Kotlin으로 대체하고 있고, Kotlin과 관련된 서적들이 활발하게 출판 되고 있다.

Kotlin에 대한 정보를 알아보던 중 다음과 같은 Kotlin의 특성에 매력을 느껴 공부해보고자 마음먹었다.


* JVM 언어로, Java의 라이브러리와 함수 등을 그대로 사용할 수 있다.
